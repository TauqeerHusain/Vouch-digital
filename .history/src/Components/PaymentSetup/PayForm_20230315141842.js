    ...
    <div className="contect-view">
      <div className="veiw-container">
        ...
        <div className="create-form">
          <div className="cr_heading">Payment Setup</div>
          <div className="cr_para">Set up payments for the client.</div>
          <form className="profile_Add_from">
            <div className="form_input_container">
              <Form.Group className="pd-y-14">
                <Form.Control
                  className="fild-border pd-y-12 pd-x-16"
              ...
              <Row>
                ...
                <Col className="pd-y-14 col-12 col-sm-12 col-md-6">
                  <Row>
                    ...
                    <Col xs={4}>
                      <Form.Control
                        className="fild-border pd-y-12 pd-x-16 col"
                        placeholder="Pincode *"
                      />
                    </Col>
                  </Row>
              ...
              <div className="form-fields">
                  ...
                  <div className="check_list">
                    <div className="check-fild">
                      <div className="check-box">
                        <Form.Check aria-label="option 1" id="UPI" />
                        <label htmlFor="UPI">UPI</label>
                      </div>
                      <div className="check-box">
                        <Form.Check aria-label="option 1" id="Cash" />{" "}
                        <label htmlFor="Cash">Cash</label>
                      </div>
                      <div className="check-box">
                        <Form.Check aria-label="option 1" id="Cheque" />{" "}
                        <label htmlFor="Cheque">Cheque</label>
                      </div>
                      <div className="check-box">
                        <Form.Check aria-label="option 1" id="Other" />{" "}
                        <label htmlFor="Other">Other</label>
                      </div>
                      <div className="check-box">
                        <Form.Check aria-label="option 1" id="Banking" />{" "}
                ...
                <div className="input-leth">
                  ...
                  <div className="check_list">
                    <div className="check-fild">
                      <div className="check-box">
                        <Form.Check type="radio" name="radio" id="Paid" />{" "}
                        <label htmlFor="Paid">Paid</label>
                      </div>
                      <div className="check-box">
                        <Form.Check type="radio" name="radio" id="Pending" />{" "}
