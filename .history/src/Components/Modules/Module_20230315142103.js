...
import AddClintNav from "../AddClint/AddClintNav";
import data from "../DataBase";

const ListMenu = ({ _id, mod_name }) => {
  return (
    <>
      ...
      <label htmlFor={`Child${_id}`}>
        <span className="act_check">
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M5.70659 7.29925C5.61435 7.20374 5.504 7.12756 5.382 7.07515C5.25999 7.02274 5.12877 6.99515 4.99599 6.994C4.86321 6.99285 4.73154 7.01815 4.60864 7.06843C4.48574 7.11871 4.37409 7.19296 4.2802 7.28686C4.18631 7.38075 4.11205 7.4924 4.06177 7.6153C4.01149 7.73819 3.98619 7.86987 3.98734 8.00265C3.9885 8.13543 4.01608 8.26665 4.06849 8.38865C4.1209 8.51066 4.19708 8.621 4.29259 8.71325L6.29259 10.7132C6.48012 10.9007 6.73443 11.006 6.99959 11.006C7.26476 11.006 7.51906 10.9007 7.70659 10.7132L11.7066 6.71325C11.8021 6.621 11.8783 6.51066 11.9307 6.38865C11.9831 6.26665 12.0107 6.13543 12.0118 6.00265C12.013 5.86987 11.9877 5.73819 11.9374 5.6153C11.8871 5.4924 11.8129 5.38075 11.719 5.28686C11.6251 5.19296 11.5134 5.11871 11.3905 5.06843C11.2677 5.01815 11.136 4.99285 11.0032 4.994C10.8704 4.99515 10.7392 5.02274 10.6172 5.07515C10.4952 5.12756 10.3848 5.20374 10.2926 5.29925L6.99959 8.59225L5.70659 7.29925Z"
              fill="#153AC7"
            />
            <rect
              x="1"
        ...
        <span className="rt_check">
          ...
          >
            <path
              d="M0.647431 15.6867C1.06523 16.1045 1.73882 16.1045 2.15662 15.6867L9.24216 8.60112C9.57469 8.26859 9.57469 7.73141 9.24216 7.39888L2.15662 0.313349C1.73882 -0.10445 1.06523 -0.10445 0.647431 0.313349C0.229632 0.731148 0.229632 1.40474 0.647431 1.82254L6.82063 8.00426L0.638905 14.186C0.229632 14.5953 0.229632 15.2774 0.647431 15.6867Z"
              fill="white"
            />
          </svg>
        </span>
    ...
    <div className="contect-view">
      <div className="veiw-container">
        ...
        <div className="create-form">
          <div className="cr_heading">Modules Setup</div>
                ...
                {data.map((CurElem) => {
                  return (
                    <div
                      key={CurElem._id}
                      className={
                        CurElem._id === CurChild + 1
                          ? "list_box active"
                          : "list_box"
                      }
                      onClick={() => {
                        SetCurChild(CurElem._id - 1);
                      }}
                    >
              ...
              <div className="modul_child_cont">
                <div className="modul_child_box">
                  <div className="modul_child-head">
                    ...
                    <div className="right">
                      <button
                        className="form-save-btn form-btn btn-flex"
                        type="button"
                      >
