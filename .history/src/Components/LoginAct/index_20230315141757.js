    ...
    <>
      <div className="Modal">
        <div className="massege-box">
          <div className="success-mgs">{Ton}</div>
          {showbtn ? (
          ...
          <div className="log_button">
            {showbtn ? (
              <NavLink to="/View_Clients" className="ok-btn">
          ...
          <form className="form-act">
            ...
            <div className="input-fild">
              ...
              <div className="input-control">
                ...
                <div
                  className="show-pwd"
                  onClick={() => setShowPwd(showPwd ? false : true)}
                >
                  <svg
                    width="16"
                    height="13"
            ...
            <div className="forget-pwd-link">Forgot Password?</div>
          </form>
          <div className="condi">
            <div className="term">
            ...
            <div className="copy">© Punctualiti 2022. All rights reserved</div>
          </div>
        </div>
